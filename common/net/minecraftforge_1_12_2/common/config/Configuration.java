...
package net.minecraftforge_1_12_2.common.config;

import static net.minecraftforge_1_12_2.common.config.Property.Type.BOOLEAN;
import static net.minecraftforge_1_12_2.common.config.Property.Type.DOUBLE;
import static net.minecraftforge_1_12_2.common.config.Property.Type.INTEGER;
import static net.minecraftforge_1_12_2.common.config.Property.Type.STRING;
...
//        String basePath = ((File)(FMLInjectionData.data()[6])).getAbsolutePath().replace(File.separatorChar, '/').replace("/.", "");
        ...
        else
        {
            ...
            catch (Throwable e)
            {
                ...
                BCLog.logger.fatal("An exception occurred while loading config file {}. This file will be renamed to {} " +
...
//            FMLLog.log.error("Error while loading config {}.", fileName, e);
            BCLog.logger.error("Error while loading config {}.", fileName, e);
        }
        finally
        {
...
//            FMLLog.log.error("Error while saving config {}.", fileName, e);
            BCLog.logger.error("Error while saving config {}.", fileName, e);
        }
    }

//    private void save(BufferedWriter out) throws IOException
    private synchronized void save(BufferedWriter out) throws IOException
    {
...
//    }
    ...
    {
        PARENT = new Configuration(new File(FMLPaths.CONFIGDIR.get().toFile(), "global.cfg"));
        PARENT.load();
    }
    ...
    public float getFloat(String name, String category, float defaultValue, float minValue, float maxValue, String comment, String langKey)
    {
        ...
        {
            BCLog.logger.error("Failed to get float for {}/{}", name, category, e);
        }
        return defaultValue;
    }
