...
//    public Collection<IFluidCoolant> getCoolants()
    public Collection<IFluidCoolant> getCoolants(World world) {
//        return coolants;
...
//    public Collection<ISolidCoolant> getSolidCoolants()
    public Collection<ISolidCoolant> getSolidCoolants(World world) {
...
//    public IFluidCoolant getCoolant(FluidStack fluid)
    public IFluidCoolant getCoolant(World world, FluidStack fluid) {
...
//    public float getDegreesPerMb(FluidStack fluid, float heat)
    public float getDegreesPerMb(World world, FluidStack fluid, float heat) {
        if (fluid == null || fluid.getAmount() == 0) {
            return 0;
        }
//        for (IFluidCoolant coolant : coolants)
...
//    public ISolidCoolant getSolidCoolant(ItemStack solid)
    public ISolidCoolant getSolidCoolant(World world, ItemStack solid) {
//        for (ISolidCoolant coolant : solidCoolants)
    ...
    public static class FluidCoolant implements IFluidCoolant {
        ...
        @Override
        public IRecipeSerializer<ICoolant> getSerializer() {
