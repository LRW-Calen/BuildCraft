...
public class CoreRecipeGenerator extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        // from 1.12.2 BCCoreRecipes.class
        // paintbrush
        ...
        for (DyeColor colour : DyeColor.values()) {
            ShapelessRecipeBuilder.shapeless(BCCoreItems.colourBrushMap.get(colour).get())
                    ...
                    .unlockedBy("has_item", has(OreDictTags.PAINT_BRUSH))
                    .group(MOD_ID)
//                    .save(consumer, MOD_ID + ":paintbrush_" + colour.getName());
                    .save(consumer);
        }
        // Wrench
//        ShapedRecipeBuilder.shaped(BCCoreBlocks.decorated.get())
