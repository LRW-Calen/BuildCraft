    ...
    protected void registerStatesAndModels() {
        ...
        getVariantBuilder(BCSiliconBlocks.advancedCraftingTable.get())
                .forAllStates(s -> ConfiguredModel.builder().modelFile(
                        models().withExistingParent("buildcraftsilicon:block/table/advanced_crafting", "minecraft:block/block")
                                .element()
                                .from(0, 0, 0)
                                .to(4, 3, 4)
        ...
        getVariantBuilder(BCSiliconBlocks.assemblyTable.get())
                .forAllStates(s -> ConfiguredModel.builder().modelFile(
                        models().withExistingParent("buildcraftsilicon:block/table/assembly", "minecraft:block/block")
                                .element()
                                .from(0, 0, 0)
                                .to(16, 1, 16)
                                .face(Direction.DOWN).texture("#bottom").end()
        ...
        getVariantBuilder(BCSiliconBlocks.chargingTable.get())
                .forAllStates(s -> ConfiguredModel.builder().modelFile(
                        models().withExistingParent("buildcraftsilicon:block/table/charging", "minecraft:block/block")
                                .element()
                                .from(0, 0, 0).to(4, 6, 4)
                                .face(Direction.DOWN).texture("#bottom").end()
                                .face(Direction.UP).texture("#bottom").end()
        ...
        getVariantBuilder(BCSiliconBlocks.integrationTable.get())
                .forAllStates(s -> ConfiguredModel.builder().modelFile(
                        models().withExistingParent("buildcraftsilicon:block/table/integration", "minecraft:block/block")
                                .element()
        ...
        // programming_table
        BlockModelBuilder programming = models().withExistingParent("buildcraftsilicon:block/table/programming", "minecraft:block/block")
                .element()
                .from(0, 0, 0).to(4, 3, 4)
                .face(Direction.DOWN).texture("#bottom").end()
                .face(Direction.UP).texture("#bottom").end()
