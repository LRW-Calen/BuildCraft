...
public class SiliconCraftingRecipeGenerator extends RecipeProvider {
    ...
    private static void makeGateRecipe1(INamedTag<Item> m, EnumGateLogic logic, EnumGateMaterial material, EnumGateModifier modifier, Consumer<IFinishedRecipe> consumer) {
    ...
    private static void makeGateRecipe2(INamedTag<Item> m, EnumGateLogic logic, EnumGateMaterial material, EnumGateModifier modifier, Consumer<IFinishedRecipe> consumer) {
    ...
    public String getName() {
        return "BuildCraft Silicon Crafting IRecipe Generator";
    }
}
