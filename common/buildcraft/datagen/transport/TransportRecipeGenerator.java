...
//    private void addPipeRecipe(Map<DyeColor, RegistryObject<? extends IItemPipe>> pipe, Object material)
    {
...
//    private void addPipeRecipe(Map<DyeColor, RegistryObject<? extends IItemPipe>> pipe, Object left, Object right)
    {
        ...
        for (DyeColor colour : DyeColor.values()) {
            ...
            ShapedRecipeBuilder.shaped(coloured, 8)
                    .pattern("lgr")
                    .define('l', left)
                    .define('g', TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge:glass/" + colour.getName())))
                    .define('r', right)
                    .unlockedBy("has_item", has(Tags.Items.GLASS))
                    .group(MOD_ID)
