...
public class TileFiller extends TileBC_Neptune
    ...
    public TileFiller() {
        super(BCBuildersBlocks.fillerTile.get());
...
//        left.add("markerBox = " + markerBox);
        ...
        left.add(new StringTextComponent("box = " + box));
        left.add(new StringTextComponent("pattern = " + patternStatement.get()));
        left.add(new StringTextComponent("mode = " + mode));
        left.add(new StringTextComponent("is_finished = " + finished));
        left.add(new StringTextComponent("lockedTicks = " + lockedTicks));
        left.add(new StringTextComponent("addon = " + addon));
        left.add(new StringTextComponent("markerBox = " + markerBox));
    }
