...
//                                        .map(Entity::getPositionVector)
                                        .map(Entity::position)
//                                        .map(schematicEntity.getPos().add(new Vector3d(getBuildingInfo().offsetPos))::distanceTo)
                                        .map(schematicEntity.getPos().add(Vector3d.atLowerCornerOf(getBuildingInfo().offsetPos))::distanceTo)
...
//                                                .map(new Vector3d(getBuildingInfo().offsetPos)::add)
                                                .map(Vector3d.atLowerCornerOf(getBuildingInfo().offsetPos)::add)
