...
public class GuiElementStatementSource<S extends IGuiSlot> implements IInteractionElement
{
    ...
    private void drawAt(@Nullable S slot, PoseStack poseStack, double x, double y)
    {
        drawGuiSlot(slot, poseStack, x, y);
    }

    public static void drawGuiSlot(@Nullable IGuiSlot guiSlot, PoseStack poseStack, double x, double y)
    {
