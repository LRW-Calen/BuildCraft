...
public class ContentsNodeGui
{
    ...
    public PagePosition render(PoseStack poseStack, int x, int y, int width, int height, PagePosition current, int index)
    {
    ...
    public void onClicked(PoseStack poseStack, int x, int y, int width, int height, PagePosition current, int index)
    {
